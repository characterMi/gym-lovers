...
import { BodyPart, ExerciseCard, Loader, Error } from './'
import { ScrollMenu, VisibilityContext } from 'react-horizontal-scrolling-menu'
import RightArrowIcon from '../assets/icons/right-arrow.png';
import LeftArrowIcon from '../assets/icons/left-arrow.png';
import { all, back, cardio, chest, lowerarms, waist, lowerlegs, neck, shoulders, upperlegs, upperarms } from "../assets/body-parts"
          ...
          {data.length > 0 ?
            <ScrollMenu position="relative" RightArrow={RightArrow} LeftArrow={LeftArrow}>
              {data.map((item, index) =>
                ...
                >
                  {isBodyParts ? <BodyPart image={images[index]} item={item} bodyPart={bodyPart} setBodyPart={setBodyPart} /> :
